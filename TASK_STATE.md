...
- Remove generated cache artifacts, run relevant checks, commit and push `chore(repo): initialize project metadata and ignore generated files`.
...
- Remote repository created but no commits have been pushed yet.
